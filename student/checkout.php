    ...
    <div class="col-lg-6 text-center">
        <div class="panel p-5">
            ...
            <div class="d-grid gap-3">
                <a class="btn btn-primary btn-lg student-action" href="<?= h(url('student/scan.php')) ?>">สแกนสินค้าต่อ</a>
                <a class="btn btn-outline-primary btn-lg student-action" href="<?= h(url('student/history.php')) ?>">ดูประวัติการซื้อ</a>
            </div>
        </div>
    </div>
</div>
