-- Insert product catalog for a newly created activity.
-- ใช้ใน phpMyAdmin/SQL ของเว็บจริงหลังสร้างกิจกรรมใหม่แล้ว
-- ค่าเริ่มต้นจะเลือก activity ที่ id ล่าสุด ไม่จำเป็นต้องเป็น active
...
-- ตรวจสอบก่อนรัน: ต้องได้ activity_id ของกิจกรรมใหม่ที่ต้องการ
SELECT
    id,
    title,
    status,
...
-- สคริปต์นี้ไม่ลบสินค้าอื่น เพื่อไม่กระทบข้อมูลเดิมโดยไม่ตั้งใจ
...
-- ตรวจสอบหลังรัน: ต้องเห็นสินค้า 19 รายการนี้ใน activity ใหม่
SELECT
    id,
    product_name,
    price,
